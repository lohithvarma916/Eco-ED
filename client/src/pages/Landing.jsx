    ...
    return (<div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Button variant="ghost" onClick={function () { return window.location.href = '/login'; }} data-testid="button-login">
                Login
              </Button>
              <Button onClick={function () { return window.location.href = '/signup'; }} data-testid="button-signup">
                Sign Up
              </Button>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080" alt="Environmental education background" className="w-full h-full object-cover"/>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-student-primary hover:bg-student-dark text-white px-8 py-4 text-lg" onClick={function () { return window.location.href = '/signup'; }} data-testid="button-join-student">
                <i className="fas fa-graduation-cap mr-3"></i>
                Join as Student
              </Button>
              <Button size="lg" className="bg-teacher-primary hover:bg-teacher-dark text-white px-8 py-4 text-lg" onClick={function () { return window.location.href = '/signup'; }} data-testid="button-join-teacher">
