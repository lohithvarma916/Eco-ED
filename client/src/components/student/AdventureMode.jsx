...
export default function AdventureMode() {
    ...
    }).data, chapters = _a === void 0 ? [] : _a;
    var _b = useQuery({
        queryKey: ["/api/progress"],
    }).data, userProgress = _b === void 0 ? [] : _b;
    return (<div>
      <div className="mb-8">
      ...
      <Card className="p-8 mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="relative w-20 h-20">
            <svg className="progress-ring w-20 h-20 transform -rotate-90">
              ...
              <circle cx="40" cy="40" r="36" stroke="#4ade80" strokeWidth="8" fill="transparent" strokeDasharray="226.19" strokeDashoffset="37.8" className="transition-all duration-500 ease-in-out"/>
            </svg>
        ...
        <div className="space-y-6">
          {chapters.length === 0 ? (<div className="text-center py-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center space-x-2">
                    ...
                    <Button className="bg-student-primary hover:bg-student-dark text-white px-4 py-1 rounded-full text-sm" data-testid="button-continue-chapter">
                      Continue
                    </Button>
                  </div>
                </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 border">
        ...
        <Card className="p-6">
          <div className="flex items-start space-x-4">
            <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&h=150" alt="Biodiversity research" className="w-24 h-18 rounded-lg object-cover"/>
            <div className="flex-1">
              ...
              <Button className="bg-student-primary hover:bg-student-dark text-white" data-testid="button-submit-findings">
                Submit Findings
              </Button>
            </div>
          </div>
