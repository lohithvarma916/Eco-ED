...
function checkAuth() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/api/auth/check', {
                        method: 'GET',
                        credentials: 'include',
                    })];
                case 1:
                    ...
                    if (!response.ok) {
                        ...
                        throw new Error("Authentication check failed: ".concat(response.status));
                    }
...
export function useAuth() {
    ...
    return {
        ...
        isLoading: isLoading,
        isAuthenticated: (data === null || data === void 0 ? void 0 : data.isLoggedIn) || false,
        error: error,
    };
}
